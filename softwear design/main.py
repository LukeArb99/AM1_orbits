...
# import sys  
# sys.path.append("./hito7") 


class Interface(object):
    def __init__(self):   
        fname = Path("D:\jorge\universidad\ampliacion de matematicas 1\AM1_orbits\softwear design\sources", "configuration.ini") 
        with open(fname, 'r') as file:
            self.filedir = json.load(file)
            print (self.filedir)
        try: 
            fname = Path("D:\jorge\universidad\ampliacion de matematicas 1\AM1_orbits\softwear design\sources", "excludes.ini") 
